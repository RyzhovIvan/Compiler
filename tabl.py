...
def p_subprogram_declarations(p): # Продукция для обозначения функций (любого их числа, т.е. их может быть много подряд)
...
if __name__=="__main__":
    ...
    funk ass (int a, d; float c) var float xyz; {
        s = s + 1; 
    }
    funk fuck (int a, d; float b) {
        s = s + 1; 
    }
    '''
